...
//   const [selectedCommunity, setSelectedCommunity] = useState(null); // Modify this line
...
//   return (
//     <div className="md:max-w-[1280px] mx-auto flex justify-center py-8">
...
//                     </div>
//                     <div>
//                       <p className="font-semibold">{ele.title.toUpperCase()}</p>
//                     </div>
//                   </div>
//                 </div>
//               );
...
//                 className="border border-gray-300 rounded-lg py-5 px-4 mr-4 shadow-lg"
//               />
//               <button className="bg-[#20B486] border p-4 shadow-lg rounded-md  text-white  hover:bg-[#20b43c] transition-colors duration-300">
//                 Search
//               </button>
//             </div>
//             <div>
//               <button
//                 className="bg-[#20B486] border p-4 shadow-lg rounded-md  text-white  hover:bg-[#20b43c] transition-colors duration-300"
//                 onClick={hanldeMoved}
//               >
//                 Add New Community
//               </button>
...
//                       onClick={() => hanldeCreatePost(selectedCommunity._id)}
//                     >
//                       Create Post
//                     </button>
//                   </div>
...
//                               height="350"
//                             />
//                             <p className="text-gray-600 mb-2 p-2">
//                               {post.desc}
//                             </p>
//                             <div className="flex items-center">
//                               <input
