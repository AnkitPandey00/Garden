    ...
    return (
      ...
      <img src={pl027_1} alt='Image' className='relative z-10 w-full max-w-[300px] md:max-w-md ml-14 py-[50px]' />
        ...
        <div className='flex flex-col justify-center '>
          ...
          <input type="password" placeholder="Password" name="password" id="password" value={password} onChange={(e) => setPassword(e.target.value)} className=" bg-white border max-w-[500px] p-4 input-box-shadow rounded-md"/>
          <input type="submit" value="Login" className="btn-login bg-[#20b486] text-white rounded hover:bg-[#20b43c] px-4 py-2 mt-4 transition-colors duration-300 max-w-[500px]" onClick={() => postData()} />
        </div>
        </div>
      </div>
    );
